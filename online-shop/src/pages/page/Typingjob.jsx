...
const Typingjob = () => {
  const quizJobData = {
    ...
    progress: 0,
    requirementText:
      "You need to verify 2 members on your level 1 after applying ads view to start for ads view",
    ...
    <div>
      <div className="bg-[#ff9100] h-20">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-white  font-bold"> {t("TypingJob")}</h1>
        </div>
      </div>
                ...
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center text-gray-800">
                    ...
                    <span className="font-bold text-lg">
                      Step {quizJobData.step}
                    </span>
                  </div>
                  <span className="text-lg font-bold text-gray-700">
                    {quizJobData.progress}% Completed
                  </span>
                </div>
