      ...
      <div className="bg-yellow-500/20 text-yellow-500 p-2 rounded-full mr-4">
        <div className="w-8 h-8 relative">
          ...
          >
            ...
            />
            <path
              d="M50 160 Q 150 50, 250 100 L 250 160 L 50 160 Z"
              fill="#FACC15"
              stroke="#333"
              strokeWidth="20"
            />
...
const WalletPage = () => {
  ...
  const menuItems = [
    {
      label: "See Voucher Balance",
      Icon: WalletIcon,
      link: "/wallet/voucherbalance",
    },
    { label: "Today Earning", Icon: WalletIcon, link: "/wallet/earning" },
    { label: "Yesterday Earning", Icon: WalletIcon, link: "/wallet/earning" },
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="mt-8 space-y-1">
            {menuItems.map((item, index) => (
              <div className="bg-white rounded-2xl w-full flex justify-between items-center h-15">
                <Link
                  to={item.link}
                  state={{ name: item.label }}
                  className="p-2 hover:bg-yellow-100 rounded-full w-full transition-colors"
                >
                  <WalletFeatureItem
                    key={index}
                    label={item.label}
