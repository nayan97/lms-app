...
const WalletPage = () => {
  ...
  const menuItems = [
    { label: "See Voucher Balance", Icon: WalletIcon },
    { label: "Today Earning", Icon: WalletIcon },
    { label: "Yesterday Earning", Icon: WalletIcon },
    { label: "7 Days Earning", Icon: WalletIcon },
    { label: "30 Days Earning", Icon: WalletIcon },
    { label: "All Time Earning", Icon: WalletIcon },
    { label: "Total Income Withdraw", Icon: WalletIcon },
  ];
