...
const WalletFeatureItem = ({ label, Icon, link }) => (
  ...
  >
    ...
    <text x="250" y="270" textAnchor="middle" fontSize="40" fontWeight="bold" fill="#333"></text>
    <text x="330" y="270" textAnchor="end" fontSize="40" fontWeight="bold" fill="#333">৳</text>
  </svg>
</div>
    ...
    {/* ✅ Right Arrow Icon Now Clickable with Dynamic Link */}
    <Link 
      to={link} 
...
const WalletPage = () => {
  ...
  // ✅ Add link for each menu item
  const menuItems = [
    { label: "See Voucher Balance", Icon: WalletIcon, link: "/wallet/voucherbalance" },
    { label: "Today Earning", Icon: WalletIcon, link: "/wallet/today" },
    { label: "Yesterday Earning", Icon: WalletIcon, link: "/wallet/yesterday" },
    { label: "7 Days Earning", Icon: WalletIcon, link: "/wallet/7days" },
    { label: "30 Days Earning", Icon: WalletIcon, link: "/wallet/30days" },
    { label: "All Time Earning", Icon: WalletIcon, link: "/wallet/alltime" },
    { label: "Total Income Withdraw", Icon: WalletIcon, link: "/wallet/withdraw" },
  ];
